...
//        factory(\App\Models\DirectorCurso::class, 4)->create();
        ...
        factory(\App\Models\Trabalho::class,10)->create();
        factory(\App\Models\DocentesAreasTrabalho::class,5)->create();
        factory(\App\Models\FicheiroReprovado::class,5)->create();
        factory(\App\Models\FicheirosTrabalho::class,15)->create();
